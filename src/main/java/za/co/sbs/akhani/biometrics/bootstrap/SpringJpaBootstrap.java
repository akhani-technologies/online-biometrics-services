package za.co.sbs.akhani.biometrics.bootstrap;
...
public class SpringJpaBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Autowired
    public void setProductRepository(ProductRepository productRepository, FingerRepository fingerRepository) {
    ...
    private void loadProducts() {
        ...
        Finger fingerTest = new Finger();
        fingerTest.setFingerIndex(2);
        fingerTest.setIdNumber("1111");
        fingerTest.setFingerprint("EWRWREWFEWREWRWEFDEW==");

        fingerRepository.save(fingerTest);

        log.info("Saved Fingerprint - id:" + fingerTest.getId());
    }
}
